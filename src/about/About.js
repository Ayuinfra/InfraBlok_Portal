...
const About = () => {
 ...
 <img
          ...
          <Grid item xs={8}>
            <h2 style={{ color: "black" }}>InfraBlok India Pvt Ltd</h2>
            <p style={{ color: "black" ,fontFamily:'cursive'}}>
              Infrablok is the preferred partner for many of the world's leading
              enterprises, SMEs, and technology startups.</p>
              <p style={{ color: "black",fontFamily:'cursive'}}> We specialize in
              ...
              Web3.</p> <p style={{ color: "black" ,fontFamily:'cursive'}}> We provide Web3 APIs that can help connect existing Web2
